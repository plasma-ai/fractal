...
| `fractal/core/node.py` (lifecycle, spawn limits), `fractal/_scripts/` (`reseed.sh` → templates)    | [[architecture/node_tree]], [[features/lifecycle/_index\|features/lifecycle]], [[features/spawning/_index\|features/spawning]], [[configuration/templates]] |
...
| `fractal/core/render.py` (prompt assembly for loop and chat; seed-time slots)                      | [[features/loop/prompt_assembly]], [[features/chat/addressing]], [[configuration/templates]]                                                                |
| `fractal/core/session.py`                                                                          | [[features/files/transcripts]]                                                                                                                              |
| `fractal/core/template.py`                                                                         | [[configuration/templates]]                                                                                                                                 |
